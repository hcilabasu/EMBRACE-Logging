...
selectionIndex = 2
worksheet.write('D3', 'Action', bold) # The action ...
actionIndex = 3
...
worksheet.write('N3', 'Sentence Text', bold)
SentenceTextIndex = 13
worksheet.write('O3', 'Manipulation Sentence', bold)
ManipulationSentenceIndex = 14
worksheet.write('P3', 'Step Number', bold)
StepNumberIndex = 15
worksheet.write('Q3', 'Idea Number', bold)
IdeaNumberIndex = 16
worksheet.write('R3', 'Question Number', bold)
QuestionNumberIndex = 17

#
worksheet.write('S3', 'Verification', bold) # if the action was correct
VerificationIndex = 18
worksheet.write('T3', 'Error Type', bold) # The type of error the user ...
ErrorTypeIndex = 19
worksheet.write('U3', 'User Step', bold)
UserStepIndex = 20
worksheet.write('V3', 'Chapter Status', bold) # ???
ChapterStatusIndex = 21
worksheet.write('W3', 'Assessment Status', bold) # ???
AssessmentStatusIndex = 22

#Study Context Data
worksheet.write('X3', 'School Code', bold)
SchoolCodeIndex = 23
worksheet.write('Y3', 'Condition', bold)
ConditionIndex = 24
worksheet.write('Z3', 'Study Day', bold)
StudyDayIndex = 25
worksheet.write('AA3', 'Participant Code', bold)
ParticipantCodeIndex = 26
worksheet.write('AB3', 'Experimenter Name', bold)
ExperimenterNameIndex = 27
worksheet.write('AC3', 'Study Language', bold)
StudyLanguageIndex = 28
worksheet.write('AD3', 'Date', bold)
DateIndex = 29
worksheet.write('AE3', 'Time', bold)
TimeIndex = 30
